        ...
        <footer className="bg-slate-100 w-full py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 px-12 max-w-7xl mx-auto">
                <div className="col-span-1 md:col-span-1">
                    <Link to="/"><div className="text-xl font-bold text-slate-900 mb-6">RoomieMatch</div></Link>
                    <p className="text-slate-500 font-body text-sm leading-relaxed">
                        © 2024 RoomieMatch. The Curated Sanctuary for Modern Living.
                    </p>
                </div>
                <div>
                    <h4 className="font-headline font-bold text-slate-900 mb-6 uppercase tracking-wider text-xs">Platform</h4>
                    <ul className="space-y-4">
                        <li><Link className="text-slate-500 hover:underline hover:text-teal-700 transition-opacity font-body text-sm" to="#">About Us</Link></li>
                        <li><Link className="text-slate-500 hover:underline hover:text-teal-700 transition-opacity font-body text-sm" to="#">Terms of Service</Link></li>
                        <li><Link className="text-slate-500 hover:underline hover:text-teal-700 transition-opacity font-body text-sm" to="#">Privacy Policy</Link></li>
                    </ul>
                </div>
                <div>
